...
- **Yi Ni 倪忆** (CalTech) -- **The next-to-top term in knot Floer homology**. ([notes]()) <br/>
...
- **Xinwen Zhu 朱歆文** (Stanford) -- **The _p_-adic Borel Hyperbolicity of Ag**. ([notes]()) <br/>
...
- **Zhipeng Liu 刘志鹏** (Kansas) -- **Some exact formulas of the KPZ fixed point and directed landscape**. ([notes]()) <br/>
...
- **Yao Yao 姚珧** (NUS) -- **Small scale formations in fluid equations with gravity**. ([notes]()) <br/>
...
- **Chenyang Xu 许晨阳** (Princeton) -- **Kähler-Einstein metric, K-stability and moduli spaces**. ([notes]()) <br/>
...
- **Yue Yu 余越** (CalTech) -- **Moduli space of non-archimedean holomorphic disks**. ([notes]()) <br/>
...
- **Gang Liu 刘钢** (East China Normal Univ.) -- **Gromov-Hausdorff convergence of Kähler manifolds**. ([notes]()) <br/>
_We survey recent progress on Gromov-Hausdorff convergence of Kähler manifolds with geometric applications._


- **Zhouli Xu 徐宙利** (UCSD) -- **The Adams differentials on the classes $h(j,3)$**. ([notes]()) <br/>
...
- **Xin Zhou 周鑫** (Cornell) -- **Some recent development in minimal surface theory**. ([notes]()) <br/>
...
- **Wei Zhang 张伟** (MIT) -- **Algebraic cycles over number fields and L-functions: conjectures and results.**. ([notes]()) <br/>
...
- **Ziyang Gao 高紫阳** (Hannover) -- **Sparsity of Rational and Algebraic Points**. ([notes]()) <br/>
...
- **Ruixiang Zhang 张瑞祥** (UCB) -- **Fourier restriction type problems: New developments in the last 15 years**. ([notes]()) <br/>
...
- **Hong Wang 王虹** (UCLA) -- **Incidence estimates and applications**. ([notes]()) <br/>
...
- **Xuhua He 何旭华** (CUHK) -- **Towards a Geometric Theory of Characters**. ([notes]()) <br/>
...
- **Zhiwei Yun 恽之玮** (MIT) -- **Functions on the commuting scheme via Langlands duality**. ([notes]()) <br/>
...
- **Botong Wang 王博潼** (Wisconsin-Madison) -- **Perverse sheaves and positivity of Euler characteristics**. ([notes]()) <br/>
...
- **Hao Shen 申皓** (Wisconsin-Madison) -- **Stochastic quantization of Yang-Mills**. ([notes]()) <br/>
