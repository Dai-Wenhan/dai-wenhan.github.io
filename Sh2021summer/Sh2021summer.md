...
- **Time:** July 26–30, 2021.
- **Veune:** Jia-yi-bing Big Lecture Hall (甲乙丙报告厅), BICMR.
...
- **Lecture 1:** Adelic interpretation of modular forms and automorphic representations. ([notes](././n1.pdf), [handout](././1.pdf))
- **Lecture 2:** Representations over local fields, nonarchimedean and archimedean. ([notes](././n2.pdf), [handout](././2.pdf))
- **Lecture 3:** (g,K)-modules. ([notes](././n3.pdf), [handout](././3.pdf))
- **Lecture 4:** Geometric modular forms, Kodaira–Spencer isomorphism, Eichler–Shimura isomorphism. ([notes](././n4.pdf), [handout](././4.pdf))
- **Lecture 5:** Tate curves, Gauss-Manin connection. ([notes](././n5.pdf), [handout](././5.pdf))
- **Lecture 6:** Galois representations associated to modular forms. ([notes](././n6.pdf), [handout](././6.pdf))
- **Lecture 7:** Siegel modular varieties, Shimura varieties of PEL type. ([notes](././n7.pdf), [handout](././7.pdf))
- **Lecture 8:** General theory of Shimura varieties. ([notes](././n8.pdf), [handout](././8.pdf))
- **Lecture 9:** Automorphic bundles on Shimura varieties. ([notes](././n9.pdf), [handout](././9.pdf))
- **Lecture 10:** Cohomology of automorphic vector bundles and étale cohomology of Shimura varieties. ([notes](././n10.pdf), [handout](././10.pdf))
